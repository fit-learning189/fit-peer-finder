...
const PeerFeedbackPage = () => {
 ...
 <h1 style={{fontSize: '1.8rem', marginBottom: '10px', color: colors.accent.limeHi}}>Feedback received</h1>
 <h2 style={{color: colors.text.hi}}>Feedback Confirmed!</h2>
 <p style={{color: colors.text.lo, marginBottom: '30px', lineHeight: '1.6'}}>
...
: "Your responses help us measure impact and spot our amazing community stars."}
 ...
 <label style={{...styles.label, color: colors.accent.azure}}>Your Volunteer's FIT Email Address *</label>
 <p style={styles.hint}>Required so we can award them their well-deserved Legacy Points!</p>
 <input style={{...styles.input, borderColor: colors.accent.azure}} type="email" name="volunteer_email" value={formData.volunteer_email} onChange={handleChange} required placeholder="Volunteer's Email" />
 </motion.div>
                )}
 </AnimatePresence>
 </div>
 ...
 <motion.div initial={{height:0, opacity:0}} animate={{height:'auto', opacity:1}} exit={{height:0, opacity:0}} style={{...styles.section, background: colors.surface.base, border: `1px solid ${colors.line.soft}`, overflow: 'hidden'}}>
 ...
 <input style={{...styles.input, borderColor: colors.accent.danger}} type="text" name="ghoster_emails" value={formData.ghoster_emails} onChange={handleChange} required placeholder="e.g., peer1@example.com, peer2@example.com" />
 </div>
                  )}
 ...
 <div style={styles.stars}>
                  {[1,2,3,4,5].map(s => (
 <span key={s} onClick={() =>handleRating(s)} style={styles.star}>
                        <StarIcon filled={s <= formData.overall_rating} />
                      </span>
                  ))}
 </div>
 ...
 <label style={{...styles.label, color: colors.accent.danger}}>Please tell us more so we can improve: *</label>
 ...
 <textarea style={{...styles.textarea, borderColor: colors.accent.danger}} name="feedback_details" value={formData.feedback_details} onChange={handleChange} required placeholder="Share your experience here..." />
 </motion.div>
                    )}
 </AnimatePresence>
 </div>
 ...
 <a href="mailto:support@frontierinstitute.tech" target="_blank" rel="noopener noreferrer" style={{display: 'inline-block', background: colors.accent.azure, color: 'white', padding: '10px 20px', borderRadius: '20px', textDecoration: 'none', fontWeight: 'bold', fontSize: '0.9rem'}}>
...
const styles = {
  ...
  header: { textAlign: 'center', color: colors.text.hi, marginBottom: '5px', fontSize: '1.8rem', fontWeight: 'bold' },
  subtext: { textAlign: 'center', color: colors.text.lo, marginBottom: '25px', fontSize: '0.95rem' },
  form: { display: 'flex', flexDirection: 'column', gap: '20px' },
  section: { background: colors.surface.base, padding: '20px', borderRadius: '12px', border: `1px solid ${colors.line.soft}` },
  label: { fontWeight: '600', fontSize: '0.95rem', color: colors.text.hi, marginBottom: '8px', display: 'block', marginTop: '10px' },
  hint: { fontSize: '0.8rem', color: colors.text.mute, marginTop: '-5px', marginBottom: '10px' },
  input: { background: colors.surface.base, color: colors.text.hi, width: '100%', padding: '12px', borderRadius: '8px', border: `1px solid ${colors.line.base}`, fontSize: '1rem', boxSizing: 'border-box' },
  select: { color: colors.text.hi, width: '100%', padding: '12px', borderRadius: '8px', border: `1px solid ${colors.line.base}`, fontSize: '1rem', background: colors.surface.raised, boxSizing: 'border-box' },
  textarea: { background: colors.surface.base, color: colors.text.hi, width: '100%', padding: '12px', borderRadius: '8px', border: `1px solid ${colors.line.base}`, fontSize: '1rem', minHeight: '80px', boxSizing: 'border-box', fontFamily: 'inherit' },
  radioGroup: { display: 'flex', flexDirection: 'column', gap: '10px', marginTop: '10px' },
  radioLabel: { display: 'flex', alignItems: 'center', gap: '10px', fontSize: '0.95rem', cursor: 'pointer', background: colors.surface.raised, padding: '10px', border: `1px solid ${colors.line.base}`, borderRadius: '8px' },
  stars: { display: 'flex', fontSize: '2.5rem', cursor: 'pointer', marginBottom: '15px' },
  star: { transition: 'color 0.2s' },
  primaryBtn: { width: '100%', padding: '15px', marginTop: '10px', background: `linear-gradient(45deg, ${colors.accent.azure}, ${colors.accent.azureHi})`, border: 'none', borderRadius: '30px', color: 'white', fontWeight: 'bold', fontSize: '1.1rem', cursor: 'pointer' },
};

...
...formData, 
 ...
 <p style={{textAlign:'center', marginBottom:'15px', color: colors.text.lo}}>
 ...
 <h3 style={styles.warningTitle}>Please Read Carefully</h3>
 ...
 <input 
                    ...
                    required 
                 />
 <p style={{fontSize: '0.8rem', color: colors.text.lo, marginTop: '5px'}}>
 ...
 <option value="5">Group of 5</option>
           ...
           {connectionType === 'offer' && (
 <div style={{background: colors.surface.base, padding: '15px', borderRadius: '8px', border: `1px solid ${colors.accent.lime}`}}>
 ...
 <input type="checkbox" name="disclaimer_agree" onChange={handleChange} required style={{accentColor: colors.accent.azure}}/>
 <label style={{marginLeft:'10px', fontSize: '0.9rem', color: colors.text.lo}}>
                    I accept the <Link to="/disclaimer" target="_blank" style={{color: colors.accent.azure, textDecoration: 'underline', fontWeight: 'bold'}}>Disclaimer</Link>.
 </label>
 </div>
...
const styles = {
  ...
  header: { textAlign: 'center', color: colors.text.hi, marginBottom: '0.5rem', fontSize: '1.8rem', fontWeight: 'bold' },
  warningBox: { background: colors.surface.base, border: `1px solid ${colors.accent.limeHi}`, borderRadius: '12px', padding: '15px', marginBottom: '25px', color: '#856404' },
  warningTitle: { margin: '0 0 10px 0', fontSize: '1rem', color: colors.accent.danger },
  warningList: { paddingLeft: '20px', margin: 0, fontSize: '0.9rem' },
  form: { display: 'flex', flexDirection: 'column', gap: '15px' },
  row: { display: 'flex', gap: '15px' },
  half: { flex: 1 },
  label: { fontWeight: '600', fontSize: '0.9rem', color: colors.text.hi, marginBottom: '5px', display: 'block' },
  input: { background: colors.surface.base, color: colors.text.hi, width: '100%', padding: '12px', borderRadius: '8px', border: `1px solid ${colors.line.base}`, fontSize: '1rem', boxSizing: 'border-box', outlineColor: colors.accent.azureHi },
  select: { color: colors.text.hi, width: '100%', padding: '12px', borderRadius: '8px', border: `1px solid ${colors.line.base}`, fontSize: '1rem', backgroundColor: colors.surface.base, boxSizing: 'border-box', outlineColor: colors.accent.azureHi },
  submitButton: { padding: '15px', marginTop: '20px', background: `linear-gradient(45deg, ${colors.accent.azure}, ${colors.accent.azureHi})`, border: 'none', borderRadius: '30px', color: 'white', fontWeight: 'bold', fontSize: '1.1rem', cursor: 'pointer' },
  checkboxContainer: { display: 'flex', alignItems: 'center', marginTop: '10px' },
  primaryBtn: { padding: '12px 24px', background: colors.accent.azure, color: 'white', border: 'none', borderRadius: '30px', fontWeight: 'bold', cursor: 'pointer' },
  secondaryBtn: { padding: '12px 24px', background: colors.surface.raised, color: colors.accent.azure, border: `1px solid ${colors.accent.azure}`, borderRadius: '30px', fontWeight: 'bold', cursor: 'pointer' }
};
